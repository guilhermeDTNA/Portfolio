...
<html lang="pt-br">
    ...
    <head>
        ...
        <script>
            function redir(){
                alert ("Solicitar número");
                window.location.assign("contato.php");
            }
        </script>
    ...
    <body id="page-top" class="contrast">
        
        <!--

        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top fundo" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none"><article>Guilherme Rocha Leite</article></span>
                <span class="d-none d-lg-block">
                    <img title="Este sou eu" class="img-fluid img-profile rounded-circle mx-auto mb-3" alt="Guilherme Rocha Leite" src="img/profile3.jpg" width="110">
                </span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#experiencia">Experiência</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#educacao">Escolaridade</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li clas="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#" id="altocontraste" onclick="window.toggleContrast()" onkeydown="window.toggleContrast()">Alto contraste</a>
                    </li>
    ...
    -->
        <div class="container-fluid p-0">
            ...
            <section class="resume-section p-3 p-lg-5 d-flex align-items-center acessibilidade" id="sobre">
                <div class="w-100">
                    ...
                    <br>
                    <div class="social-icons acessibilidade">
                        <a href="https://www.linkedin.com/in/guilherme-rocha-leite/" target="_blank">
                            <i class="fab fa-linkedin-in" title="Linkedin"></i>
                        </a>
                        <a href="https://github.com/guilhermeDTNA/" target="_blank">
                            <i class="fab fa-github" title="GitHub"></i>
                        </a>
                        <a href="https://www.youtube.com/channel/UC28bAjWwKIosH8iZDhT1YEw" target="_blank">
                            <i class="fab fa-youtube" title="YouTube"></i>
                        </a>
                        <a href="https://www.facebook.com/guilherme.rochaleite.9" target="_blank">
