...
//Verifica se existe o termo buscado
$sql_retorno = "SELECT * FROM $tipo WHERE id_$tipo = $id";

$stmt = $pdo->prepare($sql_retorno);
$stmt->execute();
$arrValues = $stmt->fetchAll(PDO::FETCH_ASSOC);

if (empty($arrValues)) {

    echo "<script type=text/javascript>alert('".ucfirst($tipo)." não encontrado(a)!');window.location='alterarDados.php?tipo=".$tipo."'</script>";
}
...
<div class="titulo_opcoes">
            <font color="black">Editar <?php echo $tipo ?>
        </div>
